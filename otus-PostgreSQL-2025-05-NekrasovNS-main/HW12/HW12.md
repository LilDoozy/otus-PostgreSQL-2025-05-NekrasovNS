...
##1. Разворачиваем БД и создаем нужные нам таблицы:
...
##2. Задача установить триггер на таблице продаж для поддержания данных в витрине в актуальном состоянии:
...
##3. Смторим результаты выполнения:
