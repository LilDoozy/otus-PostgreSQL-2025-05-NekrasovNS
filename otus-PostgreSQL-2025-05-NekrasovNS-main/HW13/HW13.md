...
##1. На созданой ВМ на базе ОС Linux Ubuntu был установлен 16-ый postgresql, создаю БД и схему для выполнения данного задания.
...
##2. Создаем директорию для бекапов и выполняем логический бекап.
...
##3. Создаем новую таблицу и пробуем восстановится.
...
##4. Выполняем бекап и восстанавливаемся с помощью утилит | pg_dump и pg_restore.
