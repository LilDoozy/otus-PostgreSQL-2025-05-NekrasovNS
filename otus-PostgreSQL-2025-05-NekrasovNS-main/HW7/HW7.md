...
Был создан log файл на 64К (Килобайт) - По умолчанию каждый файл журнала предзаписи (WAL) в PostgreSQL занимает 16 МБ:
...
Видим большую разницу в параметре пропускной способности базы данных (tps) в пользу ассинхронного режима, почти в 1.5 раза:
