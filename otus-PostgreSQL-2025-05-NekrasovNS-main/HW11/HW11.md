...
**1: Скачиваю и разварачиваю тестовую БД demo:**
...
Проверяем БД, все ли ок, выведем все таблички:
...
**2: Создаем таблицу для секционирования по списку:**
...
В созданной таблице создаем партиции:
...
**3: Подставляем данные и смотрим как изменяется производительность, так же произведем сбор данных:**
